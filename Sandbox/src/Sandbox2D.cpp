...
void Sandbox2D::OnUpdate(Bell::Timestep deltaTime)
{
...

    {
        ...
        //Bell::Renderer2D::DrawQuad(m_SquarePosition, m_SquareScale, 0, m_Texture, m_SquareColor, m_TextureScale);
        Bell::Renderer2D::DrawQuad(m_SquarePosition, { 1, 1 }, 0, m_SquareColor);
